...
public class JodaUtil {
    ...
    public static String getFirstDateOfMonth2String() {
       return getFirstDateOfMonth2String(YYYYMMDD000000);
     ...
     * @return 2018-08-01 00:00:00
     */
    public static String getFirstDateOfMonth2String(String formatter) {
        DateTime dateTime = new DateTime();
        String result = dateTime.dayOfMonth().withMinimumValue().dayOfMonth().getDateTime().toString(formatter);
